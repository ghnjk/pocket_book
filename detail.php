...
<table align="left" width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor='#B3B3B3' class='table table-striped table-bordered'>
    <tr><td bgcolor="#EBEBEB">账户明细：</td></tr>
    <tr><td bgcolor="#FFFFFF">
            <div class="search_box">
                ...
                <p><label for="time">时间：<input class="w100" value="<?php echo $s_starttime;?>" type="text" name="starttime" id="starttime" onClick="WdatePicker({})" />
    ...
    show_tab(6);
        ...
        foreach($Prolist as $row){
            ...
            echo "<ul class=\"table-row ".$fontcolor."\">";
                ...
                echo "<a class='ml8' href='javascript:' onclick='delRecord(\"record\",".$row['acid'].");'><img src='img/del.png' /></a></li>";
            echo "</ul>";
            $thiscount ++ ;
        }   
    echo "</form>";
